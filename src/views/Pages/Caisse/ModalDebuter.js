...
class ModalDebuter extends React.Component {
    ...
    handleStart=(e)=>{
        ...
        axios.post('http://localhost:8080/api/soldeDebuterJournees/ajouter/',{caisse:$('#caisse').val(),orange:$('#orange').val(),expresso:$('#expresso').val(),freeMoney:$('#tigo').val(),wari:$('#wari').val(),wizall:$('#wizall').val(),proximo:$('#proximo').val(),xpress:$('#xpress').val(),yup:$('#yup').val(),wave:$('#wave').val(),cloturer:0,sommeInitiale:somme,date:NewDate,idU:idU})
